...
const songs = [
    ...
    <div class="subtitle">Daniel Lewi</div>`,
        poster: "img/3.jpg"
    },
    {
        id: '4',
...
let waye = document.getElementsByClassName('waye')[0];
...
masterPlay.addEventListener('click', () => {
    if (music.paused || music.currentTime <= 0) {
        ...
        waye.classList.add('active2');
    } else {
        music.pause();
        masterPlay.classList.add('bi-play-fill');
        masterPlay.classList.remove('bi-pause-fill');
        waye.classList.remove('active2');
    }
})
